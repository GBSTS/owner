...
insert  into `cexperimentsteps`(`id`,`num`,`intro`,`value`,`ceid`) values (1,1,'在实验室计算机或个人电脑中，打开Dreamweaver CS6软件，截图；',0.1000,1),(2,2,'在Dreamweaver CS6中打实验01完成的文件夹，使之成为本软件内的站点文件夹，截图；',0.1000,1),(3,3,'打开实验01的index.html文件，查看文件内容以及其与css和js文件的关系，找一个你觉得最能展现效果的界面，截图。',0.2000,1);
